...
- Die Diagrammgeometrie muss so gesetzt sein, dass alle sichtbaren Elemente innerhalb ihrer Pools/Lanes liegen.
...
- Gleichzeitig soll das Modell nicht unnötig atomisiert werden.
...
- Frage-Gateways mit `Yes` und `No` sind Pflicht, wo Entscheidungen divergie ren.
...
- Haben alle diver gierenden exklusiven Gateways Frage-Namen mit `?`?
